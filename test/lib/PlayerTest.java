...
public class PlayerTest {
	...
	public void testGetRollableDie() {
		Rollable r = new Die(5);
		var p = new Player(new Name(), "BloggyJoe20", r);
	...
	public void testGenerateGamerTag() {
		var p = new Player(new Name("Ted", "Bloggs"), "Teddy50");
	...
	public void testCompareTo() {
		var p1 = new Player(new Name("Ted", "Bloggs"), "Teddy50");
		var p2 = new Player(new Name("Fred", "Bones"), "Bones99");
		var p3 = new Player(new Name("Fred", "Bones"), "Bones50");
		var p4 = new Player(new Name("Joe", "Bloggs"), "Joey99");
